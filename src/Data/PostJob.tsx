...
const content = `
<h1>About the Job</h1><p>Write description here...</p>
<h1>Responsibilities</h1><ul><li>Add responsibilities here...</li></ul>
<h1>Qualifications and Skill Sets</h1><ul><li>Add required qualification and skill set here...</li></ul>
`;
