...
const desc = `
  <h4>About The Job</h4>
  <p>
    Here at UJHUT, we are a passionate, fun-loving, growing team. 
    ...
    In this role, you would use various tech stacks, including 
    Laravel, Node JS (Adonis JS), Vue JS, React JS, Nuxt JS, Redis, 
    MySQL, MongoDB, and CSS. You will be engaged across the software 
    development life cycle to create and modify platforms and capabilities 
    in a collaborative and agile environment.
  </p>
  ...
  <ul>
    <li>3+ years of professional experience working on this field</li>
