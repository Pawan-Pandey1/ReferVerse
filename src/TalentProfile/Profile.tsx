    ...
    return  <div className="">
        ...
        <div className="px-3 mt-20">
                <div className="text-3xl font-semibold flex justify-between">{props.name}
                    <Button color="royal-purple.4" variant="light" >
                              Message
                    </Button>
                </div>
            ...
            <div className="px-3">
                ...
                <div className="sm text-mine-shaft-300 text-justify" >
                {props.about}
                </div>
            </div>
             ...
             <div className="px-3">
                ...
                <div className="flex flex-wrap gap-2">
                    {props.skills?.map((skill:any, index:number) => (
                        <div
                        key={index}
                        className="bg-royal-purple-300 text-sm font-medium bg-opacity-15 rounded-3xl text-royal-purple-400 px-3 py-1"
                        >
                        {skill}
                        </div>
                    ))}
